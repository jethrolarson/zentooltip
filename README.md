##Usage
   ...
   1. Include jQuery 1.2 or higher, jquery.zentooltip.js, and zenTooltip.css on your page
...
##Features
  ...
  * Supports jquery.bgiframe hack, if included.
  * Compressed version less than 2k
  * Tested in FF3, FF3.5, IE6, IE7, IE8, Chrome

##Text Formatting

You can put some extra formatting into your tooltips by wrapping the text with some special characters.For example text wrapped with * will be bold. e.g. title="the next word will be *bold*".
Default tags:
